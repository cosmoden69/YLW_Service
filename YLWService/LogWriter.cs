...
namespace YLWService
{
    public class LogWriter
    {
        ...
        private static int maxLogAge = int.Parse("30");//<Max Age in seconds or Config Setting>);
        private static int queueSize = int.Parse("1");//<Max Queue Size or Config Setting);
        ...
        public static void WriteLog(string logMsg)
        {
            try
            {
                ...
                string dir = YLWServiceModule.GetStartupPath() + "/log/" + DateTime.Now.ToString("yyyy") + "/" + DateTime.Now.ToString("MM");
                ...
                string file = dir + "/YLWService." + DateTime.Now.ToString("yyyyMMdd.HH") + ".log";
            ...
            while (logQueue.Count > 0)
            {
                ...
                using (FileStream fs = File.Open(logPath, FileMode.Append, FileAccess.Write))
                {
                    using (StreamWriter log = new StreamWriter(fs))
                    {
                        ...
                        log.WriteLine(string.Format("{0}", entry.Message));
                    }
                }
            }
        }
